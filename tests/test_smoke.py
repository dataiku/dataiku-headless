...
# The four Cobuild conversation tools — the only in-project write path.
...
# Every other registered tool: the read/inspect surface, bootstrap writes, and
# instance controls.
