    ...
    "plugins": frozenset(
        {
            ...
            "convert_python_recipe_to_plugin",
            "convert_webapp_to_plugin",
            "delete_plugin",
            "delete_local_plugin_file",
            "download_plugin",
            "get_plugin",
            "get_plugin_file",
            "get_plugin_settings",
            ...
            "list_plugins",
            "move_plugin_file",
            "move_local_plugin_file",
            "package_plugin",
            "put_plugin_file",
            "read_local_plugin_file",
            "rename_plugin_file",
            "scaffold_plugin",
            "set_plugin_settings",
            "set_plugin_code_env",
