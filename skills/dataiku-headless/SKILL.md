...
1. If the user asks to install, set up, connect, or repair Dataiku Headless, or its MCP tools are unavailable just after installation, read `../setup/SKILL.md` and follow it before continuing.
