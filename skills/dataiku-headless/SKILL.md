...
| Inspect code environments | `./references/administration/code-environments.md` |
| Dataiku administrative tasks (e.g. users, groups, etc.) | `./references/administration.md` |
