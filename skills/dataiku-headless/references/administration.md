...
Use this routing guide for instance-level administrative tasks. User and group listing work with any valid Dataiku API credentials; all other operations here require Dataiku administrator credentials and use direct MCP tools.
