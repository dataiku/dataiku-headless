...
Do not use it to replace an existing dataset. Use a new name or route changes
through Cobuild. Do not use it as a general substitute for creating managed or
external datasets.
