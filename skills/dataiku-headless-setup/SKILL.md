...
Report completion with the uv version, active instance name and URL, DSS version when available, and whether the Dataiku read succeeded. If a restart is required, say that setup is incomplete and give the single next action.
