---
name: split
description: Inspect split recipes and use their current settings as context for Cobuild. Use when an agent must understand an existing split recipe before asking Cobuild to create or modify that recipe type.
---

# Split Recipe Context

Use this skill to understand existing split recipes and to gather specifics for Cobuild prompts.
