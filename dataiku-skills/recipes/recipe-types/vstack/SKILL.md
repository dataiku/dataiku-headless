---
name: vstack
description: Inspect vstack recipes and use their current settings as context for Cobuild. Use when an agent must understand an existing vstack recipe before asking Cobuild to create or modify that recipe type.
---

# VStack Recipe Context

Use this skill to understand existing vstack recipes and to gather specifics for Cobuild prompts.
