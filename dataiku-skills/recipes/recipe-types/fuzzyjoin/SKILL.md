---
name: fuzzyjoin
description: Inspect fuzzyjoin recipes and use their current settings as context for Cobuild. Use when an agent must understand an existing fuzzyjoin recipe before asking Cobuild to create or modify that recipe type.
---

# Fuzzy Join Recipe Context

Use this skill to understand existing fuzzyjoin recipes and to gather specifics for Cobuild prompts.
