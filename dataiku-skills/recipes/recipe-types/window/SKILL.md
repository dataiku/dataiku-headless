---
name: window
description: Inspect window recipes and use their current settings as context for Cobuild. Use when an agent must understand an existing window recipe before asking Cobuild to create or modify that recipe type.
---

# Window Recipe Context

Use this skill to understand existing window recipes and to gather specifics for Cobuild prompts.
