---
name: upsert
description: Inspect upsert recipes and use their current settings as context for Cobuild. Use when an agent must understand an existing upsert recipe before asking Cobuild to create or modify that recipe type.
---

# Upsert Recipe Context

Use this skill to understand existing upsert recipes and to gather specifics for Cobuild prompts.
