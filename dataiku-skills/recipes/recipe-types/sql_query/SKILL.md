---
name: sql-query
description: Inspect SQL query recipes and use their current settings as context for Cobuild. Use when an agent must understand an existing SQL query recipe before asking Cobuild to create or modify that recipe type.
---

# SQL Query Recipe Context

Use this skill to understand existing SQL query recipes and to gather specifics for Cobuild prompts.
