---
name: sampling
description: Inspect sampling recipes and use their current settings as context for Cobuild. Use when an agent must understand an existing sampling recipe before asking Cobuild to create or modify that recipe type.
---

# Sampling Recipe Context

Use this skill to understand existing sampling recipes and to gather specifics for Cobuild prompts.
