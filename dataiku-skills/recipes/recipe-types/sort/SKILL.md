---
name: sort
description: Inspect sort recipes and use their current settings as context for Cobuild. Use when an agent must understand an existing sort recipe before asking Cobuild to create or modify that recipe type.
---

# Sort Recipe Context

Use this skill to understand existing sort recipes and to gather specifics for Cobuild prompts.
