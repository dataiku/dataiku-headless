---
name: prepare
description: Inspect prepare recipes and use their current settings as context for Cobuild. Use when an agent must understand an existing prepare recipe before asking Cobuild to create or modify that recipe type.
---

# Prepare Recipe Context

Use this skill to understand existing prepare recipes and to gather specifics for Cobuild prompts.
