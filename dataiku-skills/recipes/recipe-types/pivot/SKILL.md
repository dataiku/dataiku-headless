---
name: pivot
description: Inspect pivot recipes and use their current settings as context for Cobuild. Use when an agent must understand an existing pivot recipe before asking Cobuild to create or modify that recipe type.
---

# Pivot Recipe Context

Use this skill to understand existing pivot recipes and to gather specifics for Cobuild prompts.
