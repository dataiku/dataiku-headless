---
name: geojoin
description: Inspect geojoin recipes and use their current settings as context for Cobuild. Use when an agent must understand an existing geojoin recipe before asking Cobuild to create or modify that recipe type.
---

# Geo Join Recipe Context

Use this skill to understand existing geojoin recipes and to gather specifics for Cobuild prompts.
