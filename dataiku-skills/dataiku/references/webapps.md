---
name: webapps
description: Understand and inspect Dataiku WebApps and their runtime state, then use grounded context for Cobuild WebApp work. Use when reviewing an interactive application or planning a WebApp change.
---

# WebApps

Use this skill to understand existing WebApps and plan grounded application work through Cobuild.
...
The WebApp type determines its application framework and code structure. Persisted settings define the application; backend state is separate operational state used to diagnose availability, startup, and runtime failures.
...
6. Re-check runtime state after a Cobuild backend action when runtime behavior is relevant.

## Supporting Context

- Data and model integrations: `../datasets/SKILL.md` and `../machine-learning/SKILL.md`
- File integrations: `../managed_folders/SKILL.md`
- Code environments: `../code-environments/SKILL.md`
- Shared application source: `../project-libraries/SKILL.md`
- External service connections: `../connections/SKILL.md`
...
- Discover WebApp identifiers through tools; do not invent them.
