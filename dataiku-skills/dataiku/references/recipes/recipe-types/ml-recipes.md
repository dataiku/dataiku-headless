...
Read this reference when a Flow transformation creates features, scores records, or evaluates model outputs. Use `../machine-learning/SKILL.md` to inspect the relevant analysis, trained model, or saved model before describing the work to Cobuild.
