...
Use this skill to understand existing semantic models and plan grounded semantic-model work through Cobuild.
...
- Entity datasets and schemas: `../datasets/SKILL.md`
- Source Flow context: `../projects/SKILL.md` and `../recipes/SKILL.md`
- LLM or semantic-query use cases: `../llms-and-knowledge-banks/SKILL.md`
...
- Discover model, version, dataset, and entity identifiers through tools; do not invent them.
