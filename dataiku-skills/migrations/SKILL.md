...
2. Determine the source platform (e.g. Alteryx, Excel, SAS, etc.) from the user message and source bundle. Load `sources/<source platform>/<source platform>.md` skill in full. For unknown platforms, proceed best-effort.
