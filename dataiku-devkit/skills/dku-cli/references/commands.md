...
For `dku sql query` transaction behavior, `dataset info --recompute`, stale-table recovery, and GREL → SQL push-down compilation gotchas on SQL connections, see `references/sql-engines.md`.
