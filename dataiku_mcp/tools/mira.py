...
MIRA_OPERATIONS: dict[str, MiraOperation] = {
    # Infrastructure
    "list_infras": _op(
        "GET", "/mira/infras", "infrastructures", "List readable infrastructures."
    ),
    "get_infra": _op(
        "GET",
        "/mira/infras/{infra_id}",
        "infrastructures",
        "Get infrastructure status.",
    ),
    "get_infra_settings": _op(
        "GET",
        "/mira/infras/{infra_id}/settings",
        "infrastructures",
    ...
    # Agents
    "list_mira_agents": _op(
        "GET",
        "/mira/infras/{infra_id}/agents",
        "agents",
        "List agents in an infrastructure.",
    ),
    "get_mira_agent": _op(
        "GET",
        "/mira/infras/{infra_id}/agents/{agent_id}",
        "agents",
        "Get an agent summary.",
    ),
    "generate_agent_briefing": _op(
        "POST",
        "/mira/infras/{infra_id}/agents/{agent_id}/insights/briefing",
        "agents",
        "Generate and persist an agent briefing.",
    ),
    "get_mira_agent_status": _op(
        "GET",
        "/mira/infras/{infra_id}/agents/{agent_id}/status",
        "agents",
        "Get detailed agent status.",
    ),
    "get_mira_agent_settings": _op(
        "GET",
        "/mira/infras/{infra_id}/agents/{agent_id}/settings",
        "agents",
    ...
    "get_mira_agent_history": _op(
        "GET",
        "/mira/infras/{infra_id}/agents/{agent_id}/history",
        "agents",
    ...
    "get_mira_agent_metrics": _op(
        "GET",
        "/mira/infras/{infra_id}/agents/{agent_id}/metrics",
        "agents",
    ...
    "get_mira_agent_uptime_results": _op(
        "GET",
        "/mira/infras/{infra_id}/agents/{agent_id}/uptime-results",
        "agents",
    ...
    "get_mira_agent_topic_modeling": _op(
        "GET",
        "/mira/infras/{infra_id}/agents/{agent_id}/topic-modeling",
        "agents",
    ...
    "create_external_agent": _op(
        "POST",
        "/mira/infras/{infra_id}/agents/{agent_id}/actions/create-external-agent",
        "agents",
    ...
    "scan_infra": _op(
        "POST",
        "/mira/infras/{infra_id}/actions/scan",
        "operations",
        "Start an infrastructure scan.",
    ),
    "run_infra_uptime_tests": _op(
        "POST",
        "/mira/infras/{infra_id}/actions/run-uptime-tests",
        "operations",
    ...
    "fetch_agent_logs": _op(
        "POST",
        "/mira/infras/{infra_id}/agents/{agent_id}/actions/fetch-logs",
        "operations",
        "Queue an agent log fetch.",
    ),
    "fetch_agent_operational_metrics": _op(
        "POST",
        "/mira/infras/{infra_id}/agents/{agent_id}/actions/fetch-platform-operational-metrics",
        "operations",
        "Queue platform operational-metrics ingestion.",
    ),
    "setup_agent_log_fetch_dataset": _op(
        "POST",
        "/mira/infras/{infra_id}/agents/{agent_id}/actions/setup-log-fetch-dataset",
        "operations",
        "Create or configure the managed log-fetch dataset.",
        body="required",
    ),
    "list_infra_operations": _op(
        "GET",
        "/mira/infras/{infra_id}/operations",
        "operations",
        "List infrastructure operations.",
        query_params=("currentOnly",),
    ),
    "list_agent_operations": _op(
        "GET",
        "/mira/infras/{infra_id}/agents/{agent_id}/operations",
        "operations",
    ...
    "get_agent_operation": _op(
        "GET",
        "/mira/infras/{infra_id}/agents/{agent_id}/operations/{operation_id}",
        "operations",
        "Get agent operation status.",
    ),
    "get_agent_operation_result": _op(
        "GET",
        "/mira/infras/{infra_id}/agents/{agent_id}/operations/{operation_id}/result",
        "operations",
        "Get a completed agent operation result.",
    ),
    "abort_agent_operation": _op(
        "POST",
        "/mira/infras/{infra_id}/agents/{agent_id}/operations/{operation_id}/actions/abort",
        "operations",
        "Abort an agent operation.",
    ),
    "get_infra_operation": _op(
        "GET",
        "/mira/infras/{infra_id}/operations/{operation_id}",
        "operations",
        "Get infrastructure operation status.",
    ),
    "get_infra_operation_result": _op(
        "GET",
        "/mira/infras/{infra_id}/operations/{operation_id}/result",
        "operations",
        "Get a completed infrastructure operation result.",
    ),
    "abort_infra_operation": _op(
        "POST",
        "/mira/infras/{infra_id}/operations/{operation_id}/actions/abort",
        "operations",
        "Abort an infrastructure operation.",
    ),
    # Risk
    "get_risk_exposure": _op(
        "GET", "/mira/risk-exposure", "risk", "Get portfolio risk exposure."
    ),
    ...
    "get_default_risk_taxonomy": _op(
        "GET", "/mira/risk-taxonomy/default", "risk", "Get the default risk taxonomy."
    ),
    "compute_risk_taxonomy_replacement_impact": _op(
        "POST",
        "/mira/risk-taxonomy/actions/compute-replacement-impact",
        "risk",
    ...
    "get_agent_risk_assessment": _op(
        "GET",
        "/mira/infras/{infra_id}/agents/{agent_id}/risk-assessment",
        "risk",
    ...
    "sign_off_agent_risk_assessment": _op(
        "POST",
        "/mira/infras/{infra_id}/agents/{agent_id}/risk-assessment/sign-off",
        "risk",
    ...
    "download_agent_risk_evidence": _op(
        "GET",
        "/mira/infras/{infra_id}/agents/{agent_id}/risk-assessment/evidences/{evidence_id}/content",
        "risk",
    ...
    "get_mira_settings": _op(
        "GET", "/mira/settings", "settings", "Get global MIRA settings and revision."
    ),
    ...
    "list_business_kpis": _op(
        "GET",
        "/mira/settings/business-kpis",
        "settings",
        "List business KPI definitions.",
    ),
    "get_business_kpi": _op(
        "GET",
        "/mira/settings/business-kpis/{kpi_id}",
        "settings",
    ...
    "list_topic_families": _op(
        "GET",
        "/mira/settings/topic-families",
        "settings",
        "List topic-modeling families.",
    ),
    "get_topic_family": _op(
        "GET",
        "/mira/settings/topic-families/{family_id}",
        "settings",
    ...
    # Tags
    "list_mira_tags": _op(
        "GET", "/mira/tags", "tags", "List visible MIRA tag definitions."
    ),
    "update_mira_tag": _op(
        "PUT",
        "/mira/tags/{tag_name}",
    ...
    "rename_mira_tag": _op(
        "POST",
        "/mira/tags/{tag_name}/actions/rename",
        "tags",
        "Rename a tag everywhere.",
        body="required",
    ),
    "delete_mira_tag": _op(
        "DELETE", "/mira/tags/{tag_name}", "tags", "Delete a tag everywhere."
    ),
}
